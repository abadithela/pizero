...
import openpi.policies.guided_policy as guided_policy
...
@dataclasses.dataclass(frozen=True)
class LeRobotGuidedDataConfig(DataConfigFactory):
    @override
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        data_transforms = _transforms.Group(
            inputs=[guided_policy.GuidedInputs(action_dim=model_config.action_dim, model_type=model_config.model_type)],
            outputs=[guided_policy.GuidedOutputs()],
        )
